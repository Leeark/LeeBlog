<template>
  <footer>
    <WeChatModal v-if="modalActive" v-on:close-modal="closeModal" />
    <div class="container">
      <div class="left">
        <div class="col-1">
          ...
          <ul>
            <li>
              <a href="https://github.com/Leeark" target="”_blank”"
                ><github class="svg-icon"
              /></a>
            </li>
            <li>
              <a
                href="https://blog.csdn.net/UIadso?spm=1000.2115.3001.5343"
                target="”_blank”"
                ><csdn class="svg-icon"
              /></a>
            </li>
...
import csdn from "../assets/Icons/csdn-brands.svg";
